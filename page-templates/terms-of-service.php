...
<head>
  ...
  <title>Terms of Service | <?php echo esc_html($company); ?></title>
  <meta name="description" content="ReviewService.Pro Terms of Service — clear, transparent terms for our ethical ORM services including service scope, payment, cancellation, and legal protections.">
  <?php wp_head(); ?>
</head>

<body <?php body_class('legal-page terms-of-service-page'); ?>>
  <?php wp_body_open(); ?>
  <?php get_header(); ?>
